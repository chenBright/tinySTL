...
namespace tinySTL {
    ...
    // 类型 T 必须支持 % 操作符
    template <class T>
    struct modulus : public binary_finction<T, T, T> {
        T operator()(const T& lhs, const T& rhs) {
            return lhs % rhs;
        }
    };
    ...
    // 类型 T 必须支持 && 操作符
    template <class T>
    struct logical_and : public binary_finction<T, T, bool> {
        T operator()(const T& lhs, const T& rhs) {
            return lhs && rhs;
        }
    };
    ...
    // 类型 T 必须支持 & 操作符
    template <class T>
    struct bit_and : public binary_finction<T, T, bool> {
        T operator()(const T& lhs, const T& rhs) {
            return lhs & rhs;
        }
    };
    ...
    // 类型 T 必须支持 | 操作符
    template <class T>
    struct bit_or : public binary_finction<T, T, bool> {
        T operator()(const T& lhs, const T& rhs) {
            return lhs | rhs;
        }
    };
    ...
    // 类型 T 必须支持 ^ 操作符
    template <class T>
    struct bit_xor : public binary_finction<T, T, bool> {
        T operator()(const T& lhs, const T& rhs) {
            return lhs ^ rhs;
        }
    };
